/** Shown while /feed's Postgres query is in flight. Same hairline-row shape
 *  as the root fallback (this segment's own content), just under the header
 *  Next composes it with. Server Component — no client JS cost. */
    ...
    <div className="flex w-full flex-col items-center px-4 sm:px-6">
      <div className="w-full max-w-2xl">
        ...
        <div aria-hidden="true" className="flex flex-col">
          <div className="mb-6 mt-10 h-8 w-48 animate-pulse rounded bg-border" />
          {[0, 1, 2].map((i) => (
